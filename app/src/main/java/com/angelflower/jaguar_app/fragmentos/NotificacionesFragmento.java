 ...
 * Use the {@link NotificacionesFragmento#newInstance} factory method to
...
public class NotificacionesFragmento extends Fragment {
    ...
    public NotificacionesFragmento() {
    ...
    public static NotificacionesFragmento newInstance(String param1, String param2) {
        NotificacionesFragmento fragment = new NotificacionesFragmento();
